...
procedure TCustomQuestionsManager.ChangeQuestionType(Sender: TObject);
  var
...
procedure TCustomQuestionsManager.ShowMemoHint(Sender: TObject);
  begin
...
procedure TCustomQuestionsManager.ClearMemoHint(Sender: TObject);
  begin
...
function TCustomQuestionsManager.CheckForFields(Sender: TObject): Integer;
  var
    Option: TComboBox;
  begin
...
function TCustomQuestionsManager.GetComponent(Name: string): TComponent;
  var
    i: Integer;
  begin
...
procedure TCustomQuestionsManager.UpdatePos;
  var
    height: integer;
  begin
    Inc(FQuestionTop, Round(325 * 1.1));
    Inc(FScrollerRange, Round(325 * 1.1));

    FFromScroll.VertScrollBar.Range := FScrollerRange;
    height := FQuestionBox.Height;
    Inc(height, Round(325 * 1.1));

    FQuestionBox.Height := height;
    FFromScroll.VertScrollBar.Position := FScrollerRange - Round(325 * 1.1);
  end;
...
function TCustomQuestionsManager.CheckFields(var Memos: TList<TMemo>; var Edits: TList<TEdit>; var RadioButtons: TList<TRadioButton>): integer;
  var
    Memo: TMemo;
    Edit: TEdit;
...
function TCustomQuestionsManager.CheckTextEmpty(Edit: TEdit): Boolean;
  begin
    Result := False;
...
function TCustomQuestionsManager.CheckTextEmpty(Memo: TMemo): Boolean;
  begin
    Result := False;
